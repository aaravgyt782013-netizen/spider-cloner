...
<body>
    <div class="card">
        ...
        <p>Authorize access to enter the tool and sync server protocols.</p>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Spidey Command Center</title>
    <link href="https://fonts.googleapis.com/css2?family=Orbitron:wght@400;700&family=Inter:wght@300;400;600&display=swap" rel="stylesheet">
    <style>
        ...
        input { width: 100%; padding: 12px; margin-top: 10px; background: #08080a; color: #fff; border: 1px solid #262636; border-radius: 8px; box-sizing: border-box; }
...
<body>
    <div class="container">
        ...
        <p>Welcome, <b>{{ username }}</b>! Authorization verified.</p>
        <hr style="border-color: #1f1f2e;">
        <h3>Mass Join Target Server</h3>
...
def mass_join():
    ...
    return redirect(f"/?msg=Successfully forced {success_count} authorized players into server!")
